...
#             logger.warn('finish load checkpoints!')
...
if __name__ == '__main__':
    pretrained_path = '/home/ldy/project_py/object_detection/TGRS_2024/mmdetection/pretrained_backbone/eformerv2/eformer_s1_450.pth'
    model = efficientformerv2_s1_feat(pretrained=pretrained_path).cuda()
    x = torch.zeros(2, 3, 800, 800).cuda()
    y = model(x)
