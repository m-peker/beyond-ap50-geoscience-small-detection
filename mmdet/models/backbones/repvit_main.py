...
# @BACKBONES.register_module()
def repvit_ldy3(pretrained=False, num_classes = 1000, distillation=False, init_cfg=None, out_indices=[], **kwargs):
    """
    Constructs a MobileNetV3-Large model
    [4, 4, 2, 1]
    ...
    cfgs = [
        ...
        [3,   2,  128, 0, 0, 1],    # pre
        [3,   2,  256, 0, 1, 2],    # downsample
        [3,   2,  256, 1, 1, 1],    # 1
        [3,   2,  256, 0, 1, 1],    # 2
        
        [3,   2, 256, 0, 1, 1],     # pre
        [3,   2, 512, 0, 1, 2],     # downsample
        [3,   2, 512, 1, 1, 1],     # 1
    ]  
    return RepViT(cfgs, init_cfg=init_cfg, pretrained=pretrained, distillation=distillation, out_indices=out_indices)
...
if __name__ == '__main__':
    model = repvit_ldy3(out_indices = [4, 10, 14, 16]).cuda()
